...
import 'bean/WxPublicListBean.dart';
...
class WxPublicList extends BaseFulWidget {
  ...
  WxPublicList(this._title, this._id, this._color);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _WxPublicList();
  }
}
...
class _WxPublicList extends BaseStateWidget<WxPublicList> {
  ...
  Widget setBodyWidget(BuildContext buildContext) {
    return StreamBuilder<List<WxPublicItemBean>>(
        stream: _bloc.publicStream,
        builder: (context, nbs) {
          if (nbs.data != null) {
  ...
  Widget getItem(WxPublicItemBean bean) {
    return Row(
      children: <Widget>[
        Container(
