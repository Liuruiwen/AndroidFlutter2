...
class WxPublicListBean {
  ...
  List<WxPublicItemBean> get datas => _datas;
  set datas(List<WxPublicItemBean> datas) => _datas = datas;
  ...
  WxPublicListBean.fromJson(Map<String, dynamic> json) {
    _curPage = json['curPage'];
    if (json['datas'] != null) {
      _datas = new List<WxPublicItemBean>();
      json['datas'].forEach((v) {
        _datas.add(new WxPublicItemBean.fromJson(v));
      });
    }
    _offset = json['offset'];
    _over = json['over'];
...
class WxPublicItemBean {
  ...
  WxPublicItemBean.fromJson(Map<String, dynamic> json) {
